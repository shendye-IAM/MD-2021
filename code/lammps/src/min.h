...
class Min : protected Pointers {
 ...
 protected:
  ...
  // only for minimize style genetic
  int numIndividuals;            // number of individuals per population
  double p;                      // probability for mutations
  int localMinSteps;             // how many steps the local minimizer should iterate
  int elites;
