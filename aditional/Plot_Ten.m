...
% Tension
    ...
    % Tension Cement only
    % in x
    text_X_C = fileread('Ten_X_Co.txt');
    ...
    xlabel('Strain [A/A]')
    ylabel('Stress [MPa]')
    legend('Loading in x Direction, with fiber','Loading in y Direction, with fiber','Loading in z direction, with fiber','Loading in x Direction, without fiber','Loading in y Direction, without fiber','Loading in z direction, without fiber');
